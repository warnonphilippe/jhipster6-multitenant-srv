package be.civadis.jh6.srv.web.rest;

import be.civadis.jh6.srv.SrvApp;
import be.civadis.jh6.srv.config.TestSecurityConfiguration;
import be.civadis.jh6.srv.domain.JobHistory;
import be.civadis.jh6.srv.repository.JobHistoryRepository;
import be.civadis.jh6.srv.service.JobHistoryService;
import be.civadis.jh6.srv.service.dto.JobHistoryDTO;
import be.civadis.jh6.srv.service.mapper.JobHistoryMapper;
import be.civadis.jh6.srv.web.rest.errors.ExceptionTranslator;
...
import static be.civadis.jh6.srv.web.rest.TestUtil.createFormattingConversionService;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import be.civadis.jh6.srv.domain.enumeration.Language;
/**
 * Integration tests for the {@Link JobHistoryResource} REST controller.
 */
@SpringBootTest(classes = {SrvApp.class, TestSecurityConfiguration.class})
