...
import be.civadis.jh6.srv.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link be.civadis.jh6.srv.domain.Department}.
 */
@RestController
@RequestMapping("/api")
public class DepartmentResource {
    ...
    private static final String ENTITY_NAME = "srvDepartment";
